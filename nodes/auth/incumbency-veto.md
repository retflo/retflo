---
coordinate: AUTH.INCUMBENCY
tags: [incumbency, local-control, exclusion, NIMBYism, veto, housing, self-governance]
domain: auth
links:
  flow:
    - target: AUTH.LOCALTYRANNY
      why: "The incumbency veto's external exclusion mechanism connects to local tyranny's internal oppression when incumbents use procedural power to lock in majoritarian control."
    - target: AUTH.ELECTORAL
      why: "Incumbency advantage in local institutions demonstrates the electoral critique's structural tilt at the most granular level of democratic participation."
    - target: ECON.HOUSING
      why: "Housing scarcity and zoning are primary instruments of incumbency advantage"
  escalation:
    - target: AUTH.CLASS
      why: "When the incumbency veto is traced to its root, it reveals property ownership as the structural basis of political power, exposing the state as a class instrument."
...
### Distinction from AUTH.LOCALTYRANNY

AUTH.LOCALTYRANNY addresses the *internal* problem: a local majority oppressing local minorities (Jim Crow, anti-LGBTQ laws, caste enforcement). This node addresses the *external* problem: local incumbents using procedural power to exclude newcomers and non-members, externalizing costs regionally.

Different structural mechanism, different counter:
- AUTH.LOCALTYRANNY's counter: "federalism with rights floors and exit rights"
