...
| Capacity vs. Justice | [capacity-vs-justice.md](capacity-vs-justice.md) | "Justice without capacity is aspiration", hammer analogy, temporary command |
| Means-Ends Unity | [prefigurative-politics.md](prefigurative-politics.md) | Prefigurative politics, building the new world in the shell of the old, process as outcome |
| Voluntarism Requires Equality | [voluntary-servitude.md](voluntary-servitude.md) | Consent under asymmetric power, voluntary association requires material equality |
| Direct Action as Method and Pedagogy | [direct-action.md](direct-action.md) | Praxis, direct action vs. symbolic protest, self-organization as political education |
| The Transition Question | [transition.md](transition.md) | How to get from here to there, dual power, interstitial strategy, revolutionary vs. reformist paths |
