...
| "Show me the evidence they actually outperform" | Pérotin's meta-analyses, CECOP European cooperative reports, Dow's systematic reviews — all find cooperatives match or exceed conventional firms on productivity and consistently outperform on safety, retention, pay equity, and recession survival. The evidence is not ambiguous; it is ignored. Name the metric and there is a study. | **Fact** — accepts the demand for evidence as legitimate — concedes that empirical claims require empirical support, then provides it |
