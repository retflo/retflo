...
| Topic | File | Covers |
|-------|------|--------|
| Exit & Class | [exit-and-class.md](exit-and-class.md) | Exit privileges the wealthy, voice + baseline rights, resource equalization |
| Resource Equalization | [resource-equalization.md](resource-equalization.md) | Revenue sharing, conditional access, capacity-building |
| Serial Capture | [koch-capture.md](koch-capture.md) | "Distributed = many targets for oligarchs" — vulnerability is money-in-politics, not localism |
...
| Worker Self-Management | [worker-self-management.md](worker-self-management.md) | Workplace democracy, decision-making structures, historical examples |
| The Four Monopolies | [four-monopolies.md](four-monopolies.md) | Technology, finance, natural resources, communications/media monopoly power |
| The Inequality Ratchet | [inequality-ratchet.md](inequality-ratchet.md) | Wealth concentration mechanisms, r > g, policy capture feedback loop |
| Commons Management | [commons-management.md](commons-management.md) | Tragedy of the commons refutation, Ostrom's principles, commons governance |
| Housing as Operating System | [housing-chokepoint.md](housing-chokepoint.md) | Housing as convergence point, zoning, rent, displacement, NIMBYism, operating system metaphor |
