...
|---|---|---|
| "The data is unambiguous — states reduced violence" | The direction is debated more than you're representing. And even granting it, "reduced interpersonal violence while enabling industrial-scale state violence" is not the clean win you think. | **Contested** — grants outcomes-based evaluation as the shared metric; whether per-capita violence actually declined with state formation is genuinely disputed among anthropologists and historians (sampling, proxy populations, war-death coding), and the framework reads the record as violence reorganized and industrialized, not cleanly reduced — uniform prehistoric mortality data cutting the other way would move it |
| "You don't have to like the messenger to acknowledge the data" | The data is contested. And the conclusion you're drawing — sovereign monopoly is necessary — does not follow from the data even if the data is accepted. Correlation ≠ institutional necessity. | **Frame** — concedes the argument must engage with evidence, accepting empirical standards over pure theory |
| "Nuclear deterrence / international order prevents great power war" | States prevent some wars and cause others. The net calculation includes two world wars, colonial conquest, and permanent nuclear risk. "States keep the peace" is survivorship bias. | **Contested** — grants that great-power war has been rare since 1945; whether deterrence caused that quiet or the sample is too short for fat-tailed war statistics is genuinely disputed, and the framework reads it as survivorship plus permanent tail risk, not a solved problem |
