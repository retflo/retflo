...
|---|---|---|
| "The data is unambiguous — states reduced violence" | The direction is debated more than you're representing. And even granting it, "reduced interpersonal violence while enabling industrial-scale state violence" is not the clean win you think. | **Fact** — accepts that violence reduction matters as a metric, conceding outcomes-based evaluation is valid |
...
| "Nuclear deterrence / international order prevents great power war" | States prevent some wars and cause others. The net calculation includes two world wars, colonial conquest, and permanent nuclear risk. "States keep the peace" is survivorship bias. | **Fact** — accepts that state-caused violence (world wars, nuclear risk) belongs in the calculation |
