...
links:
  ...
  premise: [AUTH.LOCALTYRANNY.1, HIST.CIVILRIGHTS.1]
  escalation:
...
aliases: ["federal troops saved the day", "central authority broke the atrocity", "the state intervened to protect minorities"]
---
...
1. **Authority tolerates the injustice** for decades or centuries because it is politically convenient or institutionally aligned with it
2. **External pressure** (mass mobilization, geopolitical embarrassment, economic disruption) makes inaction more costly than action
3. **Authority intervenes** — courts, enforcement, military
4. **The intervention is presented** as proof the authority works, skipping steps 1-2
5. **The same enforcement machinery** is later repurposed for new forms of domination
