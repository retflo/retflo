...
| "Surviving is the test — if it can't survive, it's not viable" | Survival against hostile powers is not a neutral test when those powers are the systems being claimed as necessary. That's circular. See `rhet/survival-test.md`. | **Fact** — concedes these experiments were destroyed by external force, not internal failure |
