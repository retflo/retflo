...
If the retflo MCP tools are available in this session (`mcp__retflo__search_nodes` and the others), use them for ALL graph access instead of reading node files:
